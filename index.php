...
<head>
    ...
    <meta name="description" content="Book your luxury spa session at GlowSpa — facials, massages, nail care, body wraps and more. Reserve your experience online in seconds.">
...
<div class="booking-section">
        ...
        <form action="book.php" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="client_name" name="client_name" class="form-control" placeholder="Your full name" required>
                </div>
                <div class="form-group">
                    <label class="form-label" for="phone">Phone Number *</label>
                    <input type="text" id="phone" name="phone" class="form-control" placeholder="+971 50 000 0000" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="special_requests" name="special_requests" class="form-control" placeholder="Allergies, sensitivities, preferred pressure, aromatherapy preferences…"></textarea>
            </div>

            <div class="text-center mt-4">
                <button type="submit" id="submit-booking" class="btn btn-primary" style="width: 100%; padding: 1rem; font-size: 1rem; letter-spacing: 0.12em;">
                    ✿ &nbsp;Book My Session
                </button>
            </div>
    ...
    <div style="text-align: center; margin-top: 1.5rem; font-size: 0.82rem; color: var(--text-muted);">
        <a href="admin/login.php" style="color: var(--text-muted); text-decoration: none;">Admin Portal</a>
    </div>
</div>
